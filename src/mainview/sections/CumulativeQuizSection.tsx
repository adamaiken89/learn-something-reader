...
const loader = (courseId: string, quizId: string) =>
  api.quiz.cumulative(courseId, quizId || undefined).then((r) => r.questions);

export default function CumulativeQuizSection({ course, cumulativeQuizId }: Props) {
